...
#    Updated: 2021/12/20 10:44:10 by amaach           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

AFLAGS =  -lreadline -ledit -I/goinfre/amaach/.brew/opt/readline/include\
		-L/goinfre/amaach/.brew/opt/readline/lib -fsanitize=address #-Wall -Wextra -Werror 
...
SRC =  	minishell.c\
		...
		alchemist/_tools2.c alchemist/exec_pipe2.c\
